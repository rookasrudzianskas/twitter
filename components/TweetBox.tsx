...
const TweetBox = () => {
    ...
    return (
        <div className="flex space-x-2 p-5">
            <img src="https://yt3.ggpht.com/-CDERLAq3BNY7murpWzg3z9Qde3c9ZrRx59LlLEb1UzKDKZ_ckpTAOlYVQ5TJo9XTgJl2kh9bw=s900-c-k-c0x00ffffff-no-rj" className="h-14 w-14 rounded-full object-cover mt-4" alt=""/>
                ...
                <form className="flex flex-1 flex-col">
                    ...
                    <div className="flex items-center">
                        <div className="flex space-x-2 text-twitter flex-1">
                            <PhotoCameraIcon className="h-5 w-5 hover:cursor-pointer transition-transform duration-150 ease-out hover:scale-150" />
